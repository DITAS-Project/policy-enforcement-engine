        ...
        stage('Build') {
           agent {
            ...
            steps {
                ...
                sh "cd policy-enforcement-engine-interface && mvn clean install --settings /usr/share/maven/.m2/settings-docker.xml --global-settings /usr/share/maven/.m2/settings-docker.xml"
