...
sudo docker cp applicationEngine.conf  policy-enforcement-engine:/app/policy-enforcement-engine-1.0-SNAPSHOT/conf/applicationEngine.conf
sudo docker cp connections-DITAS.yml policy-enforcement-engine:/app/policy-enforcement-engine-1.0-SNAPSHOT/conf/connections-DITAS.yml
sudo docker cp demo-dpcm-DITAS.yml  policy-enforcement-engine:/app/policy-enforcement-engine-1.0-SNAPSHOT/conf/demo-dpcm-DITAS.yml
sudo docker cp demo-sparksql-1.0-SNAPSHOT-jar-with-dependencies.jar policy-enforcement-engine:/app/policy-enforcement-engine-1.0-SNAPSHOT/lib/demo-sparksql-1.0-SNAPSHOT-jar-with-dependencies.jar
