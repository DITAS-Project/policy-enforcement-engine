        ...
        stage('Build') {
           agent {
            ...
            steps {
                ...
                sh "cp dummy-policy-enforcement-engine/demo-sparksql/target/scala-2.12/dummy-policy-enforcement-engine_2.12-1.0-SNAPSHOT.jar policy-enforcement-engine-api/lib/dummy_enforcement_engine.jar"
